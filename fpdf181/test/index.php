...
$pdf->Ln(5);
$pdf->MultiCell(0,5,'         This is to certify that LANCE SAN PABLO is a regular employee of PLDT Inc. (formerly "Philippine Long Distance Telephone Company") since November 1, 1994 and presently holds the positon of Sr Telecom Associate.',0,'L');
$pdf->Ln(5);
