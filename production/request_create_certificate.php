        ...
        foreach($find_refno_res as $row){
            ...
            if($type_of_cert=='COE'){
                foreach($emp_coe_res as $x){
                    ...
                    $emp_reason = $x["termination_reason"];
                    ...
                    if($emp_dateseparated != NULL){
                        ...
                        $pdf->SetXY(100,137);
                        $pdf->MultiCell(100,0,"$emp_dateseparated ($emp_reason)",0,'L');
                        $pdf->SetXY(100,147);
                        ...
                        // $pdf->MultiCell(100,0,"",0,'L');
                        $pdf->SetXY(100,127);
                        $pdf->MultiCell(100,0,"$emp_datehired up to present.",0,'L');
                        $pdf->SetXY(100,137);
                        $pdf->MultiCell(100,0,"$emp_designation",0,'L');
                        $pdf->SetXY(100,147);
                        $pdf->MultiCell(100,0,"$emp_presentorg",0,'L');
                    ...
                    foreach($signatory_res as $sign){
                        ...
                        if(strpos($purpose, 'HDMF')!==false){
                            ...
                            $pdf->MultiCell(100,5,"not hdmf",0,'C');
